...
<body class="bg-slate-100 text-slate-900">
    <header class="bg-slate-800 shadow-lg">
      <nav class="flex items-center gap-2 h-20 justify-between px-5">
            <a href="{{ route('posts.index') }}" class="nav-link text-slate-100 flex ">Home</a>
    ...
    <main class="py-8 px-4 mx-auto max-w-screen-lg flex flex-col items-center justify-center">
        {{ $slot }}
    </main>
</body>
</html>